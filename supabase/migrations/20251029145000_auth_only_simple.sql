-- Simple Authentication Setup - Only .edu and @uwaterloo.ca emails
-- This migration is completely standalone and doesn't depend on other migrations

-- Add flagged_as_spam column if it doesn't exist (for compatibility)
...
DROP POLICY IF EXISTS "Authenticated users can submit offers" ON public.offers;

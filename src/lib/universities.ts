...
// Comprehensive email domain mappings for all universities
export const EMAIL_TO_UNIVERSITY: Record<string, string> = {
  // ============================================
  // CANADIAN UNIVERSITIES EMAIL DOMAINS
  // ============================================
  ...
  "ontariotechu.net": "Ontario Tech University",
  "queensu.ca": "Queen's University",
  "torontomu.ca": "Toronto Metropolitan University",
  "ryerson.ca": "Toronto Metropolitan University",
  ...
  "polymtl.ca": "École Polytechnique de Montréal",
  "hec.ca": "HEC Montréal",
  ...
  "ecuad.ca": "Emily Carr University of Art + Design",
  ...
  "albany.edu": "SUNY at Albany",
  "binghamton.edu": "SUNY at Binghamton",
  "buffalo.edu": "SUNY at Buffalo",
  "stonybrook.edu": "SUNY at Stony Brook",
  ...
  // Nebraska
  "unl.edu": "University of Nebraska",
  ...
  "oxon.org": "University of Oxford",
  "warwick.ac.uk": "University of Warwick",
  
  // Switzerland
  "ethz.ch": "ETH Zurich",
  "student.ethz.ch": "ETH Zurich",
  "epfl.ch": "EPFL",
  ...
  "e.ntu.edu.sg": "Nanyang Technological University",
  ...
  "connect.hku.hk": "University of Hong Kong",
  
  // China
  "fudan.edu.cn": "Fudan University",
  "pku.edu.cn": "Peking University",
  "stu.pku.edu.cn": "Peking University",
  ...
  "g.ecc.u-tokyo.ac.jp": "University of Tokyo",
